...
🕐 <!--LAST_SEEN_BEGIN-->Last seen: 2026-09-24 23:22:58 -03<!--LAST_SEEN_END-->
...
| [LLM Deep Dive](https://github.com/mneves75/llmdeepdive) | Free, open-source bilingual course on how large language models actually work | Goes beyond analogies with hands-on labs, teach-backs, quizzes, and cited empirical claims |
...
| [AIPedometer](https://mneves75.github.io/ai-pedometer/) · [Source](https://github.com/mneves75/ai-pedometer) | iOS and watchOS step tracker with on-device AI coaching | HealthKit, workouts, widgets, and Apple Foundation Models without sending health context to a cloud AI service |
...
**Languages:** TypeScript, Swift, Rust
