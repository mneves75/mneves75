...
- `~/dev/MEUS_SITES/conhecendotudo/src/data/portfolio.json`: current project summaries, live URLs, source URLs, categories, tags, and local image assets.
...
- `~/dev/MEUS_SITES/conhecendoai/README.md`: teaching project positioning and confirmed public scope.
