...
type PortfolioProjectInput = Pick<Project, 'slug' | 'title' | 'kicker' | 'summary' | 'stack' | 'category' | 'status' | 'image' | 'openSource'> & {
  source?: string;
  live?: string;
};
...
export const portfolioProjects: Project[] = [
  ...
  portfolioProject({ slug: 'weathersunscreen', title: 'WeatherSunscreen', kicker: { en: 'MOBILE APPS', pt: 'APPS MOBILE' }, summary: { en: 'Smart UV protection app with real-time sunscreen reminders.', pt: 'App inteligente de proteção UV com lembretes de protetor solar em tempo real.' }, stack: ['iOS', 'Android', 'Health', 'Weather'], category: 'Mobile apps', status: { en: 'Portfolio listing · public', pt: 'Listagem do portfólio · pública' }, live: 'https://conhecendotudo.com.br/weathersunscreen/', image: '/images/projects/portfolio-weathersunscreen.webp', openSource: false }),
